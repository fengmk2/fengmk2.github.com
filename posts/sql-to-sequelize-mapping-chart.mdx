...
description: "I like SQL to MongoDB Mapping Chart post, so I create the same chart between SQL and [Sequelize]."
published: true
---
...
### Select rows where `name` contains '_mk_' and order by id `desc`
