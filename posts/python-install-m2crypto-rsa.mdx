...
description: "最新需要用到RSA对称密钥加密，所以需要用到M2Crypto，可怜的我发现编译这东西一点都不容易，以下是我的杯具经验总结。"
published: true
---
...
则修改setup.py文件，将#'-D**i386**' 的注释去掉 (或直接下载已修改好的[setup.py](http://files.cnblogs.com/fengmk2/setup.zip) 文件替换原来的)
