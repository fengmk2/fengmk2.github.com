...
description: "mocha在Release 0.13.0 已经支持 HTMLCov 和 JSONCov 两种reporter, 那么显然可以非常简便地将 jscoverage 整合到mocha中, 进行代码覆盖率测试了."
published: true
---
...
![mocha-with-jscoverage-1.jpg](/blog/2012/02/mocha-with-jscoverage-1.jpg)

![mocha-with-jscoverage-2.jpg](/blog/2012/02/mocha-with-jscoverage-2.jpg)
