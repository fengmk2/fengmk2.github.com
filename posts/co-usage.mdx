...
```js
co(function* () {
  var rs = yield [get(1), get(2), get(3), get(4)];
  console.log(rs);
  // [1, 2, 3, 4]
})();
```
...
co(function* () {
  var ret = yield gather([random(1), random(2), random(3), random(4), random(5)]);
  console.log(ret);
})();
```
...
co(function* () {
  var ret = yield any([random(1), random(2), random(3), random(4), random(5)]);
  console.log(ret);
})();
```
