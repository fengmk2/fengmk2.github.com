...
description: "npmmirror registry 上偶尔会 CPU 狂飙一会，看日志发现这个时间段内有一个超多版本的 npm 包在同步，如 @primer/react。 最终发现这个 npm 包的 full manifests JSON 文件数据有 89MB，对它进行 JSON parse 后 Node.js…"
published: true
---
...
<img src="/blog/2025/cnpmcore-parse-img-2.png" alt="cnpmcore-parse-img-2" width={800} />

CPU、GC、QPS 的对比，更高的 QPS 峰值 CPU 更低了

<img src="/blog/2025/cnpmcore-parse-img-1.png" alt="cnpmcore-parse-img-1" width={800} />
