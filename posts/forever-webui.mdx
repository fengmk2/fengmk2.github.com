...
description: "A simple CLI tool for ensuring that a given script runs continuously (i.e. forever). 一个非常简单的CLI工具，让你的程序持续运行。"
published: true
---
...
![forever-webui.jpg](/blog/2011/11/forever-webui.jpg)
