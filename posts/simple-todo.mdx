...
description: "看到simple todo的各种python版本实现, 我也来凑凑热闹... 既然已经有这么多python版本了, 我就对比实现了一个Simple-TODO的nodejs版本: Node TODO, 模版和樣式全部copy自web.py版本."
published: true
---
...
![simple-todo.jpg](/blog/2011/07/simple-todo.jpg)
...
![代码目录](/blog/2011/07/simple-todo-code-tree.jpg)
...
![](/blog/2011/07/simple-todo-1.jpg)
