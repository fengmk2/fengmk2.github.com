...
description: "Mou, the missing Markdown editor for web developers."
published: true
---
...
Simple inline link [http://chenluois.com](http://chenluois.com), another inline link [Smaller](http://smallerapp.com), one more inline link with title [Resize](http://resizesafari.com "a Safari extension").
