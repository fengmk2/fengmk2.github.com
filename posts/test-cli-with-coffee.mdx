...
description: "npm 团队最近也在大力推广使用 node 来开发 cli 命令行工具，Building a simple command line tool with npm。"
published: true
---
...
![](/blog/2015/test-cli-with-coffee-mocha-pass.jpg)
...
![](/blog/2015/test-cli-with-coffee-mocha-2.jpg)
