...
description: "如果你需要对非 UTF8 编码的文本进行处理，如 GBK 编码的，那么我们只有遵循以下原则处理就ok："
published: true
---
...
app.use(function (req, res) {
  ...
  if (req.url === "/utf8") {
    ...
    s = s
      .replace("<title>淘宝网 - 淘！我喜欢</title>", "<title>淘宝网 - 淘！我喜欢 UTF8</title>")
  ...
  s = s
    .replace("<title>淘宝网 - 淘！我喜欢</title>", "<title>淘宝网 - 淘！我喜欢 GBK</title>")
    .replace("你好啊", "你好啊 GBK");
